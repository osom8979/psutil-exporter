...
from psutil_exporter.logging.logging import (
    DEFAULT_TIMED_ROTATING_WHEN,
    SEVERITIES,
    SEVERITY_NAME_INFO,
    TIMED_ROTATING_WHEN,
)
from psutil_exporter.system.environ import get_typed_environ_value as get_eval

PROG: Final[str] = "psutil_exporter"
DESCRIPTION: Final[str] = "Prometheus exporter using psutil"
EPILOG = f"""
...
def version() -> str:
    ...
    from psutil_exporter import __version__
